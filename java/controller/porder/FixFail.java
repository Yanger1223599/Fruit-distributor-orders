...
public class FixFail extends JFrame {
	...
	public FixFail() {
		...
		JLabel lblNewLabel = new JLabel("修改失敗");
		...
		lblNewLabel_1.setIcon(new ImageIcon(FixFail.class.getResource("/controller/1-2406191J6230-L.jpg")));
