...
public class FindPasswordMember extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					FindPasswordMember frame = new FindPasswordMember();
	...
	public FindPasswordMember() {
		...
		String show="名字:  "+member.getName()+"\n帳號:  "+member.getUsername()+"\n密碼:  "+member.getPassword();
		...
		lblNewLabel.setIcon(new ImageIcon(FindPasswordMember.class.getResource("/controller/44231b7065eb27565eaa362807a61e22.jpg")));
